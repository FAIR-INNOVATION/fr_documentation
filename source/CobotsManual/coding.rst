...
.. centered:: 表格 9.22-3-2 腕奇异LIN指令的线加加速度（单位：m/s3）
...
.. centered:: 表格 9.22-3-3 腕奇异LIN指令的角加加速度（单位：°/s3）
...
.. centered:: 表格 9.22-3-5 腕奇异ARC指令的线加加速度（单位：m/s3）
...
.. centered:: 表格 9.22-3-6 腕奇异ARC指令的角加加速度（单位：°/s3）
...
.. centered:: 表格 9.22-3-7 肩奇异的线加加速度（单位：m/s3）
...
.. centered:: 表格 9.22-3-8 肩奇异的的角加加速度（单位：°/s3）
...
.. centered:: 表格 9.22-3-9 肘奇异的线加加速度（单位：m/s3）
...
.. centered:: 表格 9.22-3-10 肘奇异的的角加加速度（单位：°/s3）
