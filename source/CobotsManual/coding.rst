...
**Step3**：选择要运行的轨迹文件，添加“轨迹预加载”指令：首先在“曲线拟合方式”中选择对轨迹点的拟合方式，包括“直线连接”、“直线拟合”、“B样条曲线”、“多项式优化方法”等，当选择“直线拟合”时，需额外设置误差限制，其他方式无需进行此设置；其次设置平滑方式和平滑精度；最后设置运行过程中的最大速度、最大加速度和最大加加速度。
...
.. centered:: 图表 9.23-3 设置轨迹预"B样条曲线"加载参数
...
.. centered:: 图表 9.23-4 实时前瞻轨迹规划的典型程序
