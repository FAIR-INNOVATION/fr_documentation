...
.. centered:: 图表 6.3‑1-2 机器人软限位设置模块
...
.. centered:: 图表 6.3‑1-3 机器人各关节实际角位置超出所设软限位范围时报错
...
.. centered:: 图表 6.3‑1-4 开启关节软限位保护功能
...
.. important:: 注意：该碰撞后响应策略功能只在LA版本下使用。
...
.. centered:: 图表 6.3-6 FT_Guard指令参数配置
...
**Step1**：点击“初始设置”->“基础”-> “关节”->“碰撞等级”，进入碰撞等级设置界面，开启拖动前力矩检测功能，如图2-1所示。

.. image:: base/069.png
   :width: 4in
   :align: center

.. centered:: 图表 6.3-9 拖动前力矩检测功能开启
...
.. centered:: 图表 6.3-12 拖动力补偿设置模块

**Step2**：补偿开关选择“开启”，自适应开关选择“关闭”，配置参数如图2-1所示，点击“应用”，功能开启成功。按下拖动按钮，就可以拖动机器人，拖动手感相较于功能开启前，比较柔顺。
...
.. centered:: 图表 6.4‑1 LUA程序暂停状态

.. image:: base/067.png
   :width: 4in
   :align: center

.. centered:: 图表 6.4‑2 LUA程序运行中状态
...
.. centered:: 图表 6.4‑6 上电期间控制箱DO输出配置
...
.. centered:: 图表 6.7‑1 基于模拟信号通信的电弧跟踪功能拓扑图
...
.. centered:: 图表 6.7‑3 控制箱模拟量电流AI配置
...
.. centered:: 图表 6.7‑4 控制箱模拟量电压AI配置
...
.. centered:: 图表 6.7‑6 控制箱模拟量电流AO配置
...
.. centered:: 图表 6.7‑7 控制箱模拟量电压AO配置
...
**Step1**：登录web界面，依次点击“初始设置”→“基础”→“坐标系”→“扩展轴”，进入扩展轴坐标系设置模块，见图2-1所示。

.. image:: base/071.png
   :width: 4in
   :align: center

.. centered:: 图表 6.8‑1 扩展轴坐标系设置模块

**Step2**：基于扩展轴与机器人的实际工作情况，进行参数设置并按需进行标定。在图2-1中，点击编辑，扩展轴坐标系名称设置为“exaxis1”，方案选择为“0-单自由度直线滑轨”，扩展轴编号选择为“1”。若导轨与机器人仅异步运行，则可不进行标定，若需同步运行，则必须进行标定，标定流程可参考相应用户手册或询问专业人员。当参数设置完后，点击“保存”，并应用相应坐标系，具体见图2-2所示。

.. image:: base/072.png
   :width: 4in
   :align: center

.. centered:: 图表 6.8‑2 扩展轴坐标系参数设置
...
.. centered:: 图表 6.8‑6 若安装方式非正装，将提示错误
...
.. centered:: 图表 6.8‑7 直线齿条导轨碰撞检测功能
...
.. centered:: 图表 6.8‑8 执行“Rail_Adaptation_Program.lua”程序，从而适配当前导轨
...
**Step1**：安装并激活力传感器。在“初始设置”->“外设”->“末端工具”的菜单栏下，点击“适配设备”进入末端外设配置界面。力传感器配置完成后，选择配置完成的力传感器编号，点击“复位”按钮，页面弹出命令发送成功后，再点击“激活”按钮，可查看力传感器信息表中的激活状态，来判断是否激活成功；此外，力传感器会有初始值，用户根据使用需求选择“零点矫正”和“去除零点”，如图2-1所示。力传感器零点矫正需要确保力传感器水平竖直向下，且传感器下未配置负载。

.. image:: base/080.png
   :width: 4in
   :align: center

.. centered:: 图表 6.9‑1 力传感器配置信息

**Step2**：力传感器负载辨识。在“初始设置”->“基础”->“负载”菜单栏下，点击“传感器”，进入力/扭矩传感器负载界面。进行传感器自动校零，记录初始位置后，切换机器人为自动模式，点击“自动校零”，如图2-2所示。

.. image:: base/081.png
   :width: 4in
   :align: center

.. centered:: 图表 6.9‑2 力传感器负载辨识
...
**Step1**：点击“初始设置”->“基础”-> “坐标系”->“工具”，进入工具坐标系设置界面，选择“坐标系名称”并设置末端工具对应的坐标系参数，如图3-1所示。

.. image:: base/082.png
   :width: 4in
   :align: center

.. centered:: 图表 6.9‑3 工具坐标系设置
...
.. centered:: 图表 6.9‑4 设置力传感器的参考坐标系
