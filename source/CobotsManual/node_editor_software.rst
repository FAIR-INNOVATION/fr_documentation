...
“跳转”指令，第一个“Body”箭头图标连接主体内容节点，第二个箭头图标连接后续跳转位置goto指令节点。（该指令需要一定编程基础，如需帮助，请联系我们）
...
.. centered:: 图表 6.2.2 “等待”指令节点界面

2.“等待DI”指令节点，参数:

- DI端口号： Ctril-DI0 ~ End-DI1
- 状态： false/true
- 最大时间(ms)： 0 ~ 10000 
...
.. centered:: 图表 6.2.3 “等待DI”指令节点界面

3.“等待多条DI”指令节点，参数:

- 条件： 与/或
- 条件选择：选择开启的端口号，以逗号隔开，例DI0,DI1
...
.. centered:: 图表 6.2.4 “等待多条DI”指令节点界面

4.“等待AI”指令节点，参数:

- 条件： 与/或
- DI端口号： Ctril-AI0 ~ End-AI0
- 条件：大于/小于
- 数值(%)：1 ~ 100
- 最大时间(ms)：0 ~ 10000
- 等待超时处理：停止报错/继续执行/一直等待 
- 等待超时处理一直等待时，最大时间默认为0

.. image:: node_editor_software/007.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.5 “等待AI”指令节点界面
...
.. centered:: 图表 6.2.7 “调用子程序”指令节点界面
...
- 是否偏移： 否/基坐标偏移/工具坐标偏移 选择否时，dx~drz参数值不生效
- 螺旋圈数：0 ~ 100
- 姿态角修正rx：-1000 ~ 1000，单位°
- 姿态角修正ry：-1000 ~ 1000，单位°
- 姿态角修正rz：-1000 ~ 1000，单位°
- 半径增量：-100 ~ 100，单位mm
- 转轴方向增量：-100 ~ 100，单位mm
...
.. centered:: 图表 6.2.17 “轨迹复现”指令节点界面
...
.. centered:: 图表 6.2.23 “工件转换”指令节点界面
...
.. centered:: 图表 6.2.24 “工具转换”指令节点界面
...
.. centered:: 图表 6.2.25 “设置DO”指令节点界面
...
.. centered:: 图表 6.2.26 “获取DI”指令节点界面
...
.. centered:: 图表 6.2.27 “设置AO”指令节点界面
...
.. centered:: 图表 6.2.28 “获取AI”指令节点界面
...
.. centered:: 图表 6.2.29 “设置模拟外部DI”指令节点界面
...
.. centered:: 图表 6.2.30 “设置模拟外部AI”指令节点界面
...
.. centered:: 图表 6.2.31 “获取模拟外部DI”指令节点界面
...
.. centered:: 图表 6.2.33 “配置UDP通信”指令节点界面
...
.. centered:: 图表 6.2.34 “运动DO”指令节点界面
...
.. centered:: 图表 6.2.35 “设置工具坐标系”指令节点界面
...
.. centered:: 图表 6.2.36 “设置工件坐标系”指令节点界面
...
.. centered:: 图表 6.2.37 “模式切换”指令节点界面
...
- 标准等级：标准等级/自定义百分比
- joint1-joint6(N): 0 ~ 100

.. image:: node_editor_software/041.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.38 “碰撞等级”指令节点界面
...
.. centered:: 图表 6.2.43 “开始喷涂”指令节点界面

.. image:: node_editor_software/047.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.44 “停止喷涂”指令节点界面

.. image:: node_editor_software/048.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.45 “开始清枪”指令节点界面

.. image:: node_editor_software/049.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.46 “停止清枪”指令节点界面
...
.. centered:: 图表 6.2.47 “UDP通信配置”指令节点界面
...
.. centered:: 图表 6.2.48 “异步运动”指令节点界面
...
.. centered:: 图表 6.2.49 “同步PTP/LIN运动”指令节点界面
...
.. centered:: 图表 6.2.50 “同步ARC运动”指令节点界面
...
.. centered:: 图表 6.2.53 “伺服ID”指令节点界面
...
.. centered:: 图表 6.2.54 “控制模式”指令节点界面
...
.. centered:: 图表 6.2.55 “伺服使能”指令节点界面
...
.. centered:: 图表 6.2.56 “伺服回零”指令节点界面
...
.. centered:: 图表 6.2.57 “位置模式”指令节点界面
...
.. centered:: 图表 6.2.58 “速度模式”指令节点界面
...
.. centered:: 图表 6.2.59 “IO实时检测”指令节点界面
...
.. centered:: 图表 6.2.60 “位置实时检测”指令节点界面
...
.. centered:: 图表 6.2.61 “跟踪开启”指令节点界面

.. image:: node_editor_software/065.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.62 “跟踪关闭”指令节点界面
...
.. centered:: 图表 6.2.63 “通讯驱动卸载”指令节点界面

.. image:: node_editor_software/067.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.64 “通讯驱动加载”指令节点界面
...
.. centered:: 图表 6.2.65 “设备使能”指令节点界面

.. image:: node_editor_software/069.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.66 “设备错误清除”指令节点界面

.. image:: node_editor_software/070.png
   :width: 6in
   :align: center

.. centered:: 图表 6.2.67 “设备力传感器清零”指令节点界面
...
.. centered:: 图表 6.2.70 “伸出距离”指令节点界面
...
.. centered:: 图表 6.2.71 “控制模式”指令节点界面
...
.. centered:: 图表 6.2.72 “焊机电压”指令节点界面
...
.. centered:: 图表 6.2.73 “焊机电流”指令节点界面
...
.. centered:: 图表 6.2.74 “收弧/起弧”指令节点界面
...
.. centered:: 图表 6.2.75 “送气/关气”指令节点界面
...
.. centered:: 图表 6.2.76 “正向送丝/停止正向送丝”指令节点界面
...
.. centered:: 图表 6.2.77 “反向送丝/停止反向送丝”指令节点界面
...
.. centered:: 图表 6.2.79 “打开/关闭传感器”指令节点界面
...
.. centered:: 图表 6.2.80 “加载/卸载传感器”指令节点界面
...
.. centered:: 图表 6.2.81 “开始/停止跟踪”指令节点界面
...
.. centered:: 图表 6.2.82 “数据记录”指令节点界面
...
.. centered:: 图表 6.2.83 “激光跟踪复现”指令节点界面
...
.. centered:: 图表 6.2.85 “寻位开始/结束”指令节点界面
...
.. centered:: 图表 6.2.86 “焊缝数据记录”指令节点界面
...
.. centered:: 图表 6.2.87 “获取焊缝起点/终点”指令节点界面
...
.. centered:: 图表 6.2.88 “焊丝寻位开始/结束”指令节点界面
...
.. centered:: 图表 6.2.89 “寻位点设置”指令节点界面
...
.. centered:: 图表 6.2.90 “计算偏移量”指令节点界面
...
.. centered:: 图表 6.2.91 “接触点数据写入”指令节点界面
...
.. centered:: 图表 6.2.92 “电弧跟踪开启/关闭”指令节点界面
...
.. centered:: 图表 6.2.93 “开启姿态调整”指令节点界面
...
.. centered:: 图表 6.2.94 “关闭姿态调整”指令节点界面
...
.. centered:: 图表 6.2.95 “开启/关闭碰撞检测”指令节点界面
...
.. centered:: 图表 6.2.96 “开启/关闭控制”指令节点界面
...
.. centered:: 图表 6.2.97 “开启/关闭柔顺控制”指令节点界面
...
.. centered:: 图表 6.2.98 “螺旋插入”指令节点界面
...
.. centered:: 图表 6.2.99 “旋转插入”指令节点界面
...
.. centered:: 图表 6.2.100 “直线插入”指令节点界面
...
.. centered:: 图表 6.2.101 “表面定位”指令节点界面
...
.. centered:: 图表 6.2.102 “中间平面开始/结束计算”指令节点界面
...
.. centered:: 图表 6.2.103 “点按力探测”指令节点界面
...
.. centered:: 图表 6.2.104 “扭矩记录开始”指令节点界面
...
.. centered:: 图表 6.2.105 “扭矩记录结束”指令节点界面
...
.. centered:: 图表 6.2.106 “扭矩记录复位”指令节点界面
...
.. centered:: 图表 6.2.107 “创建/关闭主站”指令节点界面
...
.. centered:: 图表 6.2.108 主站“读/写线圈”指令节点界面
...
.. centered:: 图表 6.2.109 主站“读离散量”指令节点界面
...
.. centered:: 图表 6.2.110 主站“读输入寄存器”指令节点界面
...
.. centered:: 图表 6.2.111 主站“读/写保持寄存器”指令节点界面
...
.. centered:: 图表 6.2.112 从站“读/写线圈”指令节点界面
...
.. centered:: 图表 6.2.113 从站“读/写离散量”指令节点界面
...
.. centered:: 图表 6.2.114 从站“读/写输入寄存器”指令节点界面
...
.. centered:: 图表 6.2.115 从站“读/写保持寄存器”指令节点界面
...
.. centered:: 图表 6.2.116 “读寄存器指令”节点界面
...
.. centered:: 图表 6.2.117 “读寄存器数据指令”节点界面
...
.. centered:: 图表 6.2.118 “写寄存器指令”节点界面
