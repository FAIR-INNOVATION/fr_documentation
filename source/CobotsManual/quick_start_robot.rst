...
-  **Step3**：长按按钮盒“按键1”切换机器人到拖动模式，此时末端LED为白青色，移动机器人至任意位置，长按“按键1”退出拖动模式，短按按钮盒“按键2”记录P1点，末端LED紫色闪烁三下，如图表2.3-3。

.. figure:: quick_start_robot/003.png
   :align: center
   :width: 6in

.. centered:: 图表 2.3-3 末端LED白青色+紫色示意图
...
-  **Step5**：长按按钮盒“按键1”退出拖动模式，此时为手动模式，末端LED为绿色，短按“按键1”切换机器人到自动模式，此时末端LED为蓝色，如图表2.3-5。

.. figure:: quick_start_robot/005.png
   :align: center
   :width: 6in

.. centered:: 图表 2.3-5 末端LED绿色+蓝色示意图
...
-  **Step1**：启动机器人，等待末端LED绿色停止闪烁，如图表2.3-8，方可操作机器人。

.. figure:: quick_start_robot/001.png
   :align: center
   :width: 4in

.. centered:: 图表 2.3-8 末端LED绿色示意图

-  **Step2**：打开示教器进入到程序编辑界面。

-  **Step3**：选择空白模板新建一个程序文件。

-  **Step4**：短按按钮盒按键1切换机器人到手动模式，此时末端LED为绿色，如图表2.3-9。

.. figure:: quick_start_robot/001.png
   :align: center
   :width: 4in

.. centered:: 图表 2.3-9 末端LED绿色示意图
...
.. centered:: 图表 2.3-11 记录并添加点P2  

-  **Step7**：保存程序文件内容。

-  **Step8**：长按按钮盒按键1退出拖动模式，此时为手动模式，末端LED为绿色，短按按钮盒按键1切换机器人到自动模式，此时末端LED为蓝色，如图表2.3-12。

.. figure:: quick_start_robot/005.png
   :align: center
   :width: 6in

.. centered:: 图表 2.3-12 末端LED绿色+蓝色示意图

-  **Step9**：短按按钮盒按键3运行该程序，末端LED蓝色闪烁两下，如图表2.3-16。

.. figure:: quick_start_robot/006.png
   :align: center
   :width: 4in

.. centered:: 图表 2.3-13 末端LED蓝色示意图
