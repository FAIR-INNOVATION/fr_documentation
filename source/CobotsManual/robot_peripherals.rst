...
Lua开放协议支持力传感器、单个夹爪、多个夹爪、力传感器及夹爪等配合使用。

操作步骤
~~~~~~~~~~~
**Step1**：进入工具应用->系统升级界面，选择末端固件.bin文件，升级末端固件。
...
.. centered:: 图表 8.3‑10 添加旋转夹爪运动指令

.. figure:: robot_peripherals/210.png
   :align: center
   :width: 6in

.. centered:: 图表 8.3‑11 旋转夹爪运动指令示例
...
**数字通信协议**：机器人通过UDP与PLC进行通信，PLC再通过CANOpen总线或其他协议与焊机通信，进而控制焊接电压、电流和焊机起弧、送丝、送气等操作(机器人UDP通信协议内容见附件一)。

通过协作机器人进行焊接控制主要包括以下几个步骤：①焊枪安装及信号接线；②焊机参数配置；③编写焊接控制程序。
...
不使用焊接工艺曲线时，即选择焊接工艺参数编号为0时，如图11，焊接过程为：
...
如图23，不使用焊接工艺参数时，即选择焊接工艺参数编号为0时，焊接过程为：
...
激光传感器适配控制器外设开放协议（仅在Linux系统下使用）
************************************************************

**Step1**：如果需要采用“开放协议连接”和“控制激光传感器”，则在传感器跟踪配置中，“协议类型”选项选择“控制器开放协议”，如果采用原方案则选择“已适配激光设备”，在跟踪传感器界面配置加载激光外设。

.. figure:: robot_peripherals/241.png
   :align: center
   :width: 6in

.. centered:: 图表 8.6‑50 “开放协议连接”和“控制激光传感器”配置界面

**Step2**：随后在“初始设置”->“外设”->“控制箱”->“外设开放协议”中，上传对应激光传感器的外设开放协议，上传成功后选择协议编号和上传的文件名，点击配置，并在设备操作及状态中，运行上传的激光传感器，即可和对应的激光传感器建立连接。

.. figure:: robot_peripherals/242.png
   :align: center
   :width: 6in

.. centered:: 图表 8.6‑51 激光传感器建立连接
...
在“初始设置”->“外设”中，点击“扩展轴”进入扩展轴配置界面，根据通讯方式点击图片选择组合方式进行对应的扩展轴外设配置。扩展轴配置首次进入界面如下：

.. figure:: robot_peripherals/106.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑1 扩展轴配置首次进入界面
...
.. centered:: 图表 8.8‑2 扩展轴坐标系应用和当前扩展轴方案显示

当只需要修改当前扩展轴坐标系时，在外设扩展轴配置界面选择坐标系即可应用。当需要更改扩展轴方案时需要进入“初始设置”->“基础”->“坐标系”->“扩展轴”界面修改。具体操作参考用户手册6.1章节。
...
.. centered:: 图表 8.8‑3 扩展轴UDP通讯参数配置
...
.. centered:: 图表 8.8‑4 扩展轴UDP建立通讯

.. figure:: robot_peripherals/116.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑5 扩展轴伺服到位
...
.. centered:: 图表 8.8‑13 扩展轴方案为“5-两自由度小车”界面
...
.. centered:: 图表 8.8‑14 两自由度小车扩展轴伺服到位
...
.. centered:: 图表 8.8‑15 两自由度小车扩展轴使能
...
.. centered:: 图表 8.8‑16 两自由度小车当前位置回零成功
...
.. centered:: 图表 8.8‑18 法奥机器人mini控制箱电气接口示意图
...
.. centered:: 图表 8.8‑19 FD100-750C驱动器面板

.. figure:: robot_peripherals/114.png
   :align: center
   :width: 6in

.. centered:: 图表 8.8‑20 FD100-750C的X3A-IN端子定义

通信配置
++++++++++++++

确保您的RS485通信线缆正确连接且机器人和伺服扩展轴都正常上电后，打开机器人WebApp，点击“初始设置”->“外设”->“扩展轴”进入“扩展轴配置”界面。如下图所示：

.. figure:: robot_peripherals/197.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑21 RS485扩展轴配置

在“扩展轴配置”界面中，点击组合方式为“控制器 + 伺服驱动器”的图片进入详细配置界面。在伺服驱动器配置中，选择编号为“1”（请注意：当连接多个伺服时，此编号用于区分不同的伺服，后面我们会多次提到该编号），厂商为“戴纳泰克”，选择相应的伺服驱动器型号，此处型号为“FD00-750C”，软件版本为V1.0，填写伺服驱动器对应的分辨率，此处为131072，根据您的机构模型填写机械传动比，此处为15.45，点击“配置”按钮。

.. figure:: robot_peripherals/198.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑22 伺服驱动器配置
...
.. centered:: 图表 8.8‑27 伺服运动调试（位置模式）
...
.. centered:: 图表 8.8‑28 伺服运动调试（速度模式）
...
.. centered:: 图表 8.8‑31 打开添加扩展轴指令页面

在添加扩展轴指令页面中选择组合方式为“控制器 + 伺服驱动器(485)”，将控制模式设为“位置模式”，点击右侧的“添加”按钮。

.. figure:: robot_peripherals/123.png
   :align: center
   :width: 6in

.. centered:: 图表 8.8‑32 设置扩展轴的控制模式

将添加扩展轴指令界面翻到底部，点击“应用”按钮。

.. figure:: robot_peripherals/124.png
   :align: center
   :width: 6in

.. centered:: 图表 8.8‑33 应用扩展轴指令
...
协作机器人通过UDP与PLC通讯，进而控制两自由度小车的运动，因此在进行两自由度小车配置及控制前，请先检查机器人与PLC之间的网络连接，确保网络连接正常，相关设备上电完成。两自由度小车的配置步骤包括：
...
(1) 进入机器人示教器界面，依次点击“初始设置”、“基础”、“坐标系”、“扩展轴”；选择一个扩展轴坐标系。
...
.. centered:: 图表 8.8‑37 选择扩展轴坐标系

(2) 点击“修改”，找到“修改向导”，选择扩展轴方案为“5-两自由度小车”，依次点击“修改向导”中的“应用”按钮和“当前扩展轴坐标系”中的“应用”按钮。

.. figure:: robot_peripherals/212.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑38 选择扩展轴方案

(3) 再依次点击“初始设置”、“外设”、“扩展轴”，选择组合方式为“控制器+PLC（UDP）”。输入对应的UDP通讯配置参数，默认参数如图所示，依次点击“配置”和“加载”按钮，建立机器人与PLC之间的UDP网络连接。

.. figure:: robot_peripherals/110.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑39 UDP通讯参数配置

两自由度小车使能与回零
++++++++++++++++++++++++++++++++++++

(1) 由于上述步骤中已经应用“5-两自由度小车”扩展轴方案和相应扩展轴坐标系，此时页面中显示当前扩展轴方案为“5-两自由度小车”；点击“使能”按钮，两自由度小车自动使能；

.. figure:: robot_peripherals/193.png
   :align: center
   :width: 6in

.. centered:: 图表 8.8‑40 焊接小车使能

(2) 在示教页面右侧UDP扩展轴状态栏中可以监控到小车的使能情况，小车的左轮和右轮分别对应扩展轴1轴和2轴。

.. figure:: robot_peripherals/116.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑41 扩展轴状态监控

(3) 确认小车两轮轴都已使能后，点击“当前位置回零”图标按钮，此时小车两轮轴依次按当前位置回零。

.. figure:: robot_peripherals/194.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑42 焊接小车回零

两自由度小车运动控制
++++++++++++++++++++++++++++++++++++

在小车运动前，请先确保已选择扩展轴方案“5-两自由度小车”并应用相应扩展轴坐标系，完成UDP通讯配置与加载，完成小车的使能与回零。

(1) 两自由度小车直线运动：打开示教界面，依次点击“初始设置”、“外设”、“扩展轴”，选择组合方式为“控制器+PLC（UDP）”，确认当前扩展轴方案为“5-两自由度小车”，在“扩展轴测试”中，选择运动方式为“直线”，输入运动距离和运动速度，确认安全后，点击“运动”按钮，小车即按照设定的距离和速度进行直线运动。运动距离为正值时，小车做前进运动；运动距离为负值时，小车做后退运动。在小车运动过程中点击“停止”按钮，小车立即停止。

.. figure:: robot_peripherals/195.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑43 焊接小车直线运动

(2) 两自由度小车圆弧运动：打开示教界面，依次点击“初始设置”、“外设”、“扩展轴”，选择组合方式为“控制器+PLC（UDP）”，确认当前扩展轴方案为“5-两自由度小车”，在“扩展轴测试”中，选择运动方式为“圆弧”，输入半径、角度和速度，确认安全后，点击“运动”按钮，小车即按照设定的半径和角度进行圆弧运动。角度值为正值时，小车做向右转弯运动；角度值为负值时，小车做向左转弯运动。在小车运动过程中点击“停止”按钮，小车立即停止。

.. figure:: robot_peripherals/196.png
   :align: center
   :width: 4in

.. centered:: 图表 8.8‑44 焊接小车圆弧运动
...
.. centered:: 图表 8.11‑3 力/扭矩传感器负载辨识
...
.. centered:: 图表 8.11‑4 力/扭矩传感器拖动锁定
...
.. centered:: 图表 8.11‑5 FT_Guard指令编辑
...
.. centered:: 图表 8.11‑6 FT_Control指令编辑
...
.. centered:: 图表 8.11‑7 FT_Spiral指令编辑
...
.. centered:: 图表 8.11‑10 FT_FindSurface指令编辑
...
.. centered:: 图表 8.11‑11 FT_CalCenter指令编辑
...
.. centered:: 图表 8.13‑5 码垛模式A配置

.. figure:: robot_peripherals/154.png
   :align: center
   :width: 4in

.. centered:: 图表 8.13‑6 码垛模式B配置
...
.. centered:: 图表 8.15‑2 力传感器配置

.. figure:: robot_peripherals/162.png
   :align: center
   :width: 4in

.. centered:: 图表 8.15‑3 力传感器激活
...
.. centered:: 图表 8.15‑4 安装拖动把手并设置工具坐标系

.. figure:: robot_peripherals/165.png
   :align: center
   :width: 4in

.. centered:: 图表 8.15‑5 虚拟墙参数配置
...
.. centered:: 图表 8.15‑6 范围内干涉

.. figure:: robot_peripherals/167.png
   :align: center
   :width: 4in

.. centered:: 图表 8.15‑7 范围外干涉
...
.. centered:: 图表 8.15‑8 两点法建立干涉区

.. figure:: robot_peripherals/169.png
   :align: center
   :width: 4in

.. centered:: 图表 8.15‑9 中心点+边长法建立干涉区
...
.. centered:: 图表 8.15‑10 力传感器辅助拖动的参数设置
...
.. centered:: 图表 8.15‑12 工具坐标系设置

.. figure:: robot_peripherals/172.png
   :align: center
   :width: 4in

.. centered:: 图表 8.15‑13 力/扭矩传感器自动校零
...
.. centered:: 图表 8.15‑14 六维力辅助拖动的配置参数
...
.. centered:: 图表 8.16‑1 机器人扩展轴加激光定点跟踪系统构成
...
.. centered:: 图表 8.16‑5 激光传感器连接与配置页面

点击“初始设置”->“外设”->“跟踪”->“传感器”按钮进入配置页面。配置页面包括“传感器配置”、“通信配置与加载”、“基准计算”、“三点与四点寻位求交点坐标功能”，点击“传感器配置”可设置传感器输入量滤波参数，点击“通信配置与加载”可输入对应通信参数连接激光传感器。
...
.. centered:: 图表 8.16‑8 选择6点法对焊枪进行标定
...
.. centered:: 图表 8.16‑9 选择5点法对激光传感器进行标定
...
.. centered:: 图表 8.16‑10 扩展轴坐标系设置页面

点击“初始设置”->“基础”->“扩展轴”进入扩展轴坐标系设置界面，选择需要设置的扩展轴号，点击编辑按钮，选择“4-单自由度变位机”并保存。

.. figure:: robot_peripherals/229.png
   :align: center
   :width: 6in

.. centered:: 图表 8.16‑11 扩展轴标定页面
...
.. centered:: 图表 8.16‑12 设置激光数据有变换类型
...
.. centered:: 图表 8.16‑14 添加开始记录激光数据指令
...
.. centered:: 图表 8.16‑15 添加结束记录激光数据指令
...
.. centered:: 图表 8.16‑16 添加运动到焊接点指令
...
.. centered:: 图表 8.16‑17 添加轨迹复现激光记录的数据指令
...
.. centered:: 图表 8.16‑18 扩展轴加激光数据有变换定点跟踪示例程序
...
.. centered:: 图表 8.16‑19 设置激光数据有变换类型

点击“初始设置”->“外设”->“跟踪”->“传感器”，在页面下拉框点击“传感器配置”，将“数据处理”调整为无变换类型的数据。

.. figure:: robot_peripherals/238.png
   :align: center
   :width: 6in

.. centered:: 图表 8.16‑20 激光跟踪功能页面
...
.. centered:: 图表 8.16‑21 添加边记录边复现指令
...
.. centered:: 图表 8.16‑22 扩展轴加激光数据无变换定点跟踪示例程序
...
.. centered:: 图表 8.17‑1 机器人与CNC的FOCAS通信拓扑图

目前控制箱基于FOCAS通信的CNC功能包支持的机床控制、状态反馈的功能如表所示。

.. centered:: 表格 8.17-1 基于FOCAS通信的CNC功能包支持的功能表
...
.. centered:: 表格 8.17-2 CNCComSet函数参数说明表
...
**Step2**：完成开放协议lua文件的编写，打开WebAPP，选择“初始设置”->“外设”->“控制箱”->“外设开放协议”，选择刚刚的CtrlDev_CNC_demo.lua文件并上传，选择文件中设置的ID，下拉选择上传的开放协议文件并点击配置。如图所示。

.. figure:: robot_peripherals/215.png
   :align: center
   :width: 6in

.. centered:: 图表 8.17‑3 开放协议文件上传与配置
...
.. centered:: 图表 8.17‑4 FOCAS通信连接建立 
...
.. centered:: 图表 8.17‑5 CNC状态反馈栏 

CNC各状态反馈显示灯的含义如下表所示。

.. centered:: 表格 8.17-3 CNC状态反馈图标灯含义表
...
.. centered:: 图表 8.18‑1 机器人传送带跟踪系统构成拓扑图
...
.. centered:: 图表 8.18‑4 传送带跟踪追检运动示教示例
...
.. centered:: 图表 8.18‑5 传送带跟踪追检运动示教后执行示例
...
.. centered:: 图表 8.18‑10 一段典型的传送带程序跟踪运动程序
...
.. centered:: 图表 8.18‑11 一段典型的传送带阻塞跟踪抓取运动程序
...
控制器外设开放协议通常是一个可运行的LUA程序，程序包含通讯创建指令、循环向从站设备写入控制数据和读取实时状态数据指令，执行该LUA程序时，机器人与设备建立通讯，并进行数据交互。控制器外设开放协议LUA程序中可自定义IP地址、端口号、周期等通讯参数，用户在使用时需要根据实际设备情况对该协议内容进行修改。控制器外设开放协议支持的设备包括打磨头、激光传感器、CNC、焊机等。控制器外设开放协议文件名称需以CtrlDev_开头，如“CtrlDev_Welding.lua”，最多支持4个开放协议同时运行。

在机器人WebApp中依次点击“初始设置”、“外设”、“控制箱”、“控制器外设开放协议”，点击“上传”按钮，将编写完成的开放协议LUA程序文件上传至控制器中。选择一个开放协议ID和开放协议名称，点击“配置”按钮(选择协议ID需与开放协议文件中编写的ID一致)，为每个开放协议指定一个ID。

.. figure:: robot_peripherals/254.png
   :align: center
   :width: 6in

.. centered:: 图表 8.19‑1 控制器外设开放协议上传与配置
...
.. centered:: 图表 8.19‑2 控制器外设开放协议加载与运行指示
...
**①数字量/模拟量(控制箱IO)**：机器人通过控制箱上的数字输出DO、模拟输出AO端口控制焊机，使用时需要配置起弧、送丝、送气控制的数字输出DO端口编号，焊接电流、焊接电压控制的模拟输出AO端口编号，以及焊接电流、焊接电压与模拟输出电压之间的对应关系。

**②数字通信协议(UDP)**：机器人控制箱与PLC进行UDP通信，PLC再进而与焊机进行进行通讯控制。使用时需建立机器人与PLC之间、PLC与焊机之间的通信连接。

**③数字通信协议(ModbusTCP)**：机器人加载焊机开放协议，在开放协议中进行通讯参数和相关数据寄存器地址定义，实现机器人对焊机的控制。

在进行焊接作业前，需要根据不同的焊接控制类型进行相应的配置操作，而在不同配置下进行焊机调试与焊接程序编写操作类似。
...
.. centered:: 图表 8.19‑6 选择“数字通信协议(ModbusTcp)”
...
.. centered:: 图表 8.19‑10 点击“焊接”指令

在弹出焊接指令添加页面中选择“数字通信协议(Modbus Tcp)”，依次选择“起弧”、点击“添加”、点击“收弧”、点击“添加”按钮，最后点击“应用”按钮。

.. figure:: robot_peripherals/264.png
   :align: center
   :width: 6in

.. centered:: 图表 8.19‑11 添加起弧、收弧指令
...
使用开放协议适配焊接手柄时，在机器人上电启动后需要先进入web页面进行开放协议上传配置。

依次点击“初始设置”->“外设”->“末端工具”-“开放协议”，点击“末端协议通讯”，点击“进入Boot”，点击“上传”开放协议，上传完成后重启设备，即可使用末端lua开放协议适配焊接手柄。

.. figure:: robot_peripherals/270.png
   :align: center
   :width: 6in

.. centered:: 图表 8.20‑1 末端开放协议上传

依次点击“初始设置”->“外设”->“末端工具”-“开放协议”，点击“末端协议启用”，选择设备类型为“焊接手柄”，点击启用即可适配焊接手柄，启用后断电重启参数保持。

.. figure:: robot_peripherals/271.png
   :align: center
   :width: 6in

.. centered:: 图表 8.20‑2 末端开放协议启用
