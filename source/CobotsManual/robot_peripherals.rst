...
-  **组合指令**：选择“IO信号”后，特定条件下显示“焊机选择”和“点速度”配置项，生成不同程序指令。同时新增焊接工艺编号的选择，此外起弧收弧的最大时间最大可配置为10000ms。摆动编号默认为0，如配置了“摆动开始”则可以选择摆动编号。IO键与摆动开始设置一致。
...
.. note::
  1. 对于FR3WML机器人，参数设置建议如下：拖动增益[0.15, 0.15, 0.15, 0.15, 0.15, 0.2]，开启阻抗功能后的阻尼增益[0.1, 0.1, 0.1, 0.05, 0.05, 0.05]。
