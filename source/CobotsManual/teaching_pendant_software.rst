...
.. centered:: 图表 3.7‑26 图形化编程页面布局整体设计
...
.. centered:: 图表 3.7‑36 当前页面程序未保存验证
...
.. centered:: 图表 3.7‑37 切换页面程序未保存验证
