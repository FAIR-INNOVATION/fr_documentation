...
- 系统目前自带有中文（简体）、中文（繁體）、英语（English）、法语（français）、韩语（한국어）、日语（日本語）和俄语（Русский）七种语言。
...
在Web端示教页面，点击“初始设置”→“基础”→“安装页面”，其页面布局如下所示。具体的说明如下：
