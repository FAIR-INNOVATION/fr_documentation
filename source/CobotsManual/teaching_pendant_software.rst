...
.. centered:: 图表 4.3‑1 虚拟轨迹绘制及工具模型导入
...
管理员可使用默认值也可输入角度值。输入角度值，可分别对机器人关节正负角度进行限位，当输入值超出\ `表1.1-1 机器人基本参数 <robot_brief_introduction.html#id2>`__\ 节所列出的机器人关节软限位角度值，会将限位角度调整为所能设定最大值。当机器人报出超出指令超限时，需要进入拖动模式，将机器人关节拖动至限位角度之内。界面如3.4-17所示。

.. image:: teaching_pendant_software/043.png
   :width: 3in
   :align: center

.. centered:: 图表 4.4‑17 机器人限位示意图
...
该功能是设置手动/自动下机器人运行的速度，若当前为自动运行模式，则设置的速度为机器人自动运行速度，若当前为手动运行模式，则设置的速度为机器人手动运行速度。设置数值为机器人标准速度百分比，若设置100，即标准速度的百分之百（标准速度请翻阅\ `表格1.1-1 机器人基本参数 <robot_brief_introduction.html#id2>`__\ ）。

.. image:: teaching_pendant_software/049.png
   :width: 3in
   :align: center

.. centered:: 图表 4.4-23 速度缩放设置
...
.. centered:: 图表 4.5‑13 smart Tool IO
...
.. centered:: 图表 4.7‑6-7 MoveDO指令界面
...
.. centered:: 图表 4.7‑6-8 ToolList指令界面
...
.. centered:: 图表 4.7‑6-10 Collision指令界面
...
.. centered:: 表格 4.1-8 上下补偿开启左右补偿关闭
...
.. centered:: 表格 4.1-9 上下补偿关闭左右补偿开启
...
.. centered:: 图表 4.7‑28 图形化编程页面布局整体设计
...
.. centered:: 图表 4.7‑38 当前页面程序未保存验证
...
.. centered:: 图表 4.7‑39 切换页面程序未保存验证
