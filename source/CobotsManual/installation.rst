...
.. centered:: 图表 3.1-2 FR3WMS型号协作机器人

.. figure:: installation/107.png
	:align: center
	:width: 6in

.. centered:: 图表 3.1-3 FR3WML型号协作机器人

.. figure:: installation/108.png
	:align: center
	:width: 6in

.. centered:: 图表 3.1-4 FR3C型号协作机器人
...
关于数字量输入的软件设置项目只有“通用输入有效状态”，其表征检测到的输入有效时对应的数字量电压电平值。此设置可用使用户更加灵活的使用使用数量输入。

	.. figure:: installation/090.png
		:align: center
		:width: 6in

  .. centered:: 图表 3.3-3 通用输入有效状态

“通用输入有效状态”在不同的设置下，当数字量输入的外接开关处于不同状态下，软件检测的有效状态对照表如下：
...
关于数字量输出的软件设置项目有“上电期间控制箱DO输出”和“通用输出有效状态”两个设置项，其中“上电期间控制箱DO输出”表征在控制箱上电期间，控制系统还没初始化完成时输出的电平，其可以对用对应不同的输出有效状态，可以灵活应对上电期间对输出状态有特殊要求的场合。“通用输出有效状态”表征输出有效时需要控制输出的数字量输出电压电平值。此设置可用使用户更加灵活的使用使用数量输出。
...
(2) “通用输出有效状态”在不同的设置下，当数字量输出的有效状态对照表如下：

	.. figure:: installation/101.png
		:align: center
		:width: 6in

	.. centered:: 图表 3.3-8 通用输出有效状态
...
FR3/FR3WMS/FR3WML/FR3C机器人手臂安装要求
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. centered:: 图表 3.4-2 FR3/FR3WMS/FR3WML/FR3C型号协作机器人安装尺寸
...
.. important:: 
	...
	.. centered:: 图表 3.4-3 FR3/FR3WMS/FR3WML/FR3C型号协作机器人低要求安装底座
	...
	.. centered:: 图表 3.4-4 FR3/FR3WMS/FR3WML/FR3C型号协作机器人高要求安装底座
...
.. centered:: 图表 3.4-13 FR3/FR3WMS/FR3WML/FR3C/FR5/FR10/FR16型号机器人末端法兰图纸
...
(1) FR3WMS在完整性能下可携带3kg及以下的负载，见“蓝色包络线”。
(2) 当负载为3kg至5kg时，为扩展后的负载能力，见“红色包络线”，此时机器人可运行在如下状态：
...
.. centered:: 图表 3.4-16 FR3WMS型号协作机器人负载曲线

FR3WML型号协作机器人负载曲线
*******************************

FR3WML型号协作机器人最大可携带负载为4kg，额定负载为3kg，负载曲线见图所示。负载曲线的具体释义如下：
...
.. centered:: 图表 3.4-17 FR3WML型号协作机器人负载曲线

FR3C型号协作机器人负载曲线
*******************************

FR3C型号协作机器人最大可携带负载为5kg，额定负载为3kg，负载曲线见图所示。负载曲线的具体释义如下：
...
.. centered:: 图表 3.4-18 FR3C型号协作机器人负载曲线
...
.. centered:: 图表 3.4-20 FR10型号协作机器人负载曲线
...
.. centered:: 图表 3.4-21 FR16型号协作机器人负载曲线
...
.. centered:: 图表 3.4-22 FR20型号协作机器人负载曲线
...
.. centered:: 图表 3.4-23 FR30型号协作机器人负载曲线
