...
在配方编辑中，可选择是否使用码垛工作站，如图2-2。使用码垛工作站则对应码垛功能使用工作站PLC中I/O信号完成；若选择无码垛工作站，则默认使用控制箱上I/O信号完成码垛功能。
...
（1）在选择使用码垛工作站后，点击扩展I/O配置，可根据对应功能及与PLC的I/O接口实际接线，自定义选择码垛功能的I/O信号配置，如图2-3为码垛工作站默认接线配置。
...
（2）若选择不使用码垛工作站，则默认使用控制箱I/O信号，根据对应功能及与控制箱I/O接口的实际接线，自定义选择码垛功能的I/O信号配置，如图2-4为无码垛工作站（使用控制箱I/O）默认接线配置。
