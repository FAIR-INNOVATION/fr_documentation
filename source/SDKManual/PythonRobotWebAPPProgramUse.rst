...
.. csv-table:: 
    ...
    "描述", "设置开机自动加载默认的作业程序"
    "参数", "- ``必选参数 flag``：1-开机自动加载默认程序，0-不自动加载默认程序
...
.. code-block:: python
    ...
    flag = 1
    ret = robot.LoadDefaultProgConfig(flag,'/fruser/testPTP.lua')    # 设置开机自动加载默认的作业程序
...
.. csv-table:: 
    ...
    "描述", "加载指定的作业程序"
    "参数", "- ``必选参数 program_name``：作业程序名及路径，如“/fruser/movej.lua”，其中“/fruser/”为固定路径"
    "返回值", "错误码 成功-0  失败- errcode"
